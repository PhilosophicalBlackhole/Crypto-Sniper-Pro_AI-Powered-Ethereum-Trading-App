        ...
        >
          ...
          {currentPage === 'tutorials' && (
            <div className="text-center py-16">
              <div className="max-w-4xl mx-auto p-8 bg-slate-900/60 dark:bg-slate-900/40 backdrop-blur-md rounded-lg border border-slate-700/40 dark:border-slate-700/40 shadow-xl">
                <h2 className="text-2xl font-bold text-white dark:text-white mb-6 drop-shadow-lg">Tutorials & Guides</h2>
                <p className="text-white dark:text-slate-300 mb-8 font-bold drop-shadow-md">Learn how to maximize your crypto sniping success</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 bg-slate-800/50 dark:bg-slate-800/30 rounded-lg border border-slate-600/40 dark:border-slate-600/40">
                    <h3 className="text-lg font-semibold text-white dark:text-white mb-3">Getting Started</h3>
                    <p className="text-white dark:text-slate-200 text-sm mb-4 font-bold">Learn the basics of crypto sniping and how to set up your first snipe target.</p>
                  ...
                  <div className="p-6 bg-slate-800/50 dark:bg-slate-800/30 rounded-lg border border-slate-600/40 dark:border-slate-600/40">
                    <h3 className="text-lg font-semibold text-white dark:text-white mb-3">Advanced Strategies</h3>
                    <p className="text-white dark:text-slate-200 text-sm mb-4 font-bold">Master advanced techniques for timing, gas optimization, and MEV protection.</p>
                    <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                      Coming Soon
                    </button>
                  </div>
